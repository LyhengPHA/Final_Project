...
class ExpenseTrackerClass(CTk):
    ...
    def create_widgets(self):
        ...
        self.menu_frame = tk.Frame(self, bg= "#2C3E50")
        self.menu_frame.pack(side='right', fill='y', padx=10, pady=20)
        ...
        for text, command in buttons_data:
            button = CTkButton(self.menu_frame, text=text, height=35, command=command, fg_color="#3498DB", hover_color="#2980B9", text_color="white", corner_radius=8)
            button.pack(pady=15, padx=10, fill='x')

        # Right side frame for changing content
        self.window_frame = tk.Frame(self, bg="gray26")  # Light gray background for the content area
        self.window_frame.pack(side="right", fill="both", expand=True, padx=20, pady=20)
